...
class SimulationWindow:
    ...
    def _add_base_stations(self):
        self._base_stations = []
        self._base_stations.append(BaseStation((100, 100),
                                               u.DEFAULT_BASE_STATION_POWER))
        self._base_stations.append(BaseStation((u.WINDOW_SIZE - 100, 100),
                                               u.DEFAULT_BASE_STATION_POWER))
        self._base_stations.append(BaseStation((100, u.WINDOW_SIZE - 100),
                                               u.DEFAULT_BASE_STATION_POWER))
        self._base_stations.append(BaseStation((u.WINDOW_SIZE - 100, u.WINDOW_SIZE - 100),
                                               u.DEFAULT_BASE_STATION_POWER))
        self._base_stations.append(BaseStation(u.CENTER_POINT,
                                               u.DEFAULT_BASE_STATION_POWER))
    ...
    def _refresh_connections(self):
        for ms in self._mobile_stations:
            bs = self._find_best_base_station(ms)
    ...
    def _find_best_base_station(self, mobile_station):
        ...
        if max_power_density > u.POWER_DENSITY_THRESHOLD:
            ...
            return self._base_stations[max_index]
        else:
            return None
